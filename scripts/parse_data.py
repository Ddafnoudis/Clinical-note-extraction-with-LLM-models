...
def parse_data(data_folder_path: Path, df_eng_path: Path, df_dk_path: Path, results: Path)-> DataFrame:
    """
    Condition statements
    """
    # Condition statemet
    if os.path.exists(df_eng_path) and os.path.exists(df_dk_path) and os.path.exists(results):
